...
public:
  ...
  static constexpr auto SETTING_AUDIOOUTPUT2_ENABLED = "audiooutput2.enabled";
  static constexpr auto SETTING_AUDIOOUTPUT2_AUDIODEVICE = "audiooutput2.audiodevice";
  static constexpr auto SETTING_AUDIOOUTPUT2_CHANNELS = "audiooutput2.channels";
  static constexpr auto SETTING_AUDIOOUTPUT2_CONFIG = "audiooutput2.config";
  static constexpr auto SETTING_AUDIOOUTPUT2_SAMPLERATE = "audiooutput2.samplerate";
  static constexpr auto SETTING_AUDIOOUTPUT2_STEREOUPMIX = "audiooutput2.stereoupmix";
  static constexpr auto SETTING_AUDIOOUTPUT2_MAINTAINORIGINALVOLUME =
      "audiooutput2.maintainoriginalvolume";
  static constexpr auto SETTING_AUDIOOUTPUT2_PROCESSQUALITY = "audiooutput2.processquality";
  static constexpr auto SETTING_AUDIOOUTPUT2_ATEMPOTHRESHOLD = "audiooutput2.atempothreshold";
  static constexpr auto SETTING_AUDIOOUTPUT2_STREAMSILENCE = "audiooutput2.streamsilence";
  static constexpr auto SETTING_AUDIOOUTPUT2_STREAMNOISE = "audiooutput2.streamnoise";
  static constexpr auto SETTING_AUDIOOUTPUT2_GUISOUNDMODE = "audiooutput2.guisoundmode";
  static constexpr auto SETTING_AUDIOOUTPUT2_GUISOUNDVOLUME = "audiooutput2.guisoundvolume";
  static constexpr auto SETTING_AUDIOOUTPUT2_PASSTHROUGH = "audiooutput2.passthrough";
  static constexpr auto SETTING_AUDIOOUTPUT2_PASSTHROUGHDEVICE = "audiooutput2.passthroughdevice";
  static constexpr auto SETTING_AUDIOOUTPUT2_AC3PASSTHROUGH = "audiooutput2.ac3passthrough";
  static constexpr auto SETTING_AUDIOOUTPUT2_AC3TRANSCODE = "audiooutput2.ac3transcode";
  static constexpr auto SETTING_AUDIOOUTPUT2_EAC3PASSTHROUGH = "audiooutput2.eac3passthrough";
  static constexpr auto SETTING_AUDIOOUTPUT2_DTSPASSTHROUGH = "audiooutput2.dtspassthrough";
  static constexpr auto SETTING_AUDIOOUTPUT2_TRUEHDPASSTHROUGH = "audiooutput2.truehdpassthrough";
  static constexpr auto SETTING_AUDIOOUTPUT2_DTSHDPASSTHROUGH = "audiooutput2.dtshdpassthrough";
  static constexpr auto SETTING_AUDIOOUTPUT2_DTSHDCOREFALLBACK = "audiooutput2.dtshdcorefallback";
  static constexpr auto SETTING_AUDIOOUTPUT2_VOLUMESTEPS = "audiooutput2.volumesteps";
